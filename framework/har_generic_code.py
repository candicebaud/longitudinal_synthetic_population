...
def compute_polytope_vertices(A, b):
    ...
    -------
    ndarray
        Array of vertices of the feasible polytope.

    Raises
    ------
    ValueError
        If the constraint system is infeasible or the polytope is empty.
    """
    if A is not None and b is not None:
        ...
        lin_rows, red_rows, new_pos = cdd.matrix_canonicalize(mat)
